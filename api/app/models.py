...
class OrgInvite(Base):
    """One-time invitation into an existing organization.

    Invite tokens are stored hashed only; accepting sets `accepted_at` and
    creates the user in the target org with the declared role.
    """
